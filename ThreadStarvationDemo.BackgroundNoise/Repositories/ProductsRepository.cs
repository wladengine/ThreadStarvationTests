...
public partial class ProductsRepository
{
    ...
    public IEnumerable<Product> GetProducts()
    {
        ...
        return db.Query<Product>(@"WAITFOR DELAY '00:00:00.5'; SELECT Id, Name FROM wh.Product;");
    }

    public async Task<IEnumerable<Product>> GetProductsAsync()
    {
        using var db = DbConnection;
        return await db.QueryAsync<Product>(@"WAITFOR DELAY '00:00:00.5'; SELECT Id, Name FROM wh.Product;");
    }
}
